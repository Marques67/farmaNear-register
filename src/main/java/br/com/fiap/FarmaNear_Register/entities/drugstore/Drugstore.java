...
public class Drugstore implements DrugstoreEntityInterface {
    ...
    public Drugstore(Long cnpj, String name, String email, String phone, Address address) {
        this.cnpj = cnpj;
        this.name = name;
        this.email = email;
        this.phone = phone;
    ...
    public Drugstore(Long cnpj, String name, String email, String phone, Address address, Set<Product> products) {
        this.cnpj = cnpj;
        this.name = name;
        this.email = email;
        this.phone = phone;
